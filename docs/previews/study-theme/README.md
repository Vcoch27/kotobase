...
- `flashcard-desktop.png`: 1440 × 1100, front face, light theme.
- `flashcard-back-desktop.png`: 1440 × 1100, back face, light theme.
- `flashcard-mobile.png`: 390 × 844, scrolled to the learning card.
- `quiz-desktop.png`: 1440 × 1100, front/question artwork, light theme.
...
- `settings-background.png`: 390 × 844, “Ẩn ảnh nền” enabled in Settings.

        ...
        >
          {isLoadingHistory ? (
            <div className="flex items-center gap-2 px-2 py-3 text-sm text-stone-500">
             ...
             <div className="px-2 py-3 text-sm leading-6 text-stone-500">Chưa có bản ghi ảnh nào. Nhập prompt để bắt đầu.</div>
          ) : (
                ...
                >
                  ...
                  >
                    ...
                    <div className={cn("mt-1 text-xs", active ? "text-stone-500" : "text-stone-400")}>
                      {conversation.turns.length} lần · {formatConversationTime(conversation.updatedAt)}
                    </div>
                    {stats.running > 0 || stats.queued > 0 ? (
                      <div className="mt-2 flex flex-wrap items-center gap-2 text-[11px]">
                        ...
                        {stats.queued > 0 ? (
                          <span className="rounded-full bg-amber-50 px-2 py-1 text-amber-700">Xếp hàng {stats.queued}</span>
                        ) : null}
                      </div>
                    ) : null}
                  </button>

        ...
        <CardContent className="space-y-7 p-6 sm:p-8">
          <div className="space-y-4 text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm leading-6 text-stone-500">Nhập khóa để tiếp tục sử dụng quản lý tài khoản và tạo hình ảnh.</p>
            </div>
          </div>
          ...
          >
            <span className="flex items-center justify-center gap-2">
              <LoaderCircle className={`size-4 animate-spin ${isSubmitting ? "" : "hidden"}`} />
              Đăng nhập
            </span>
          </Button>
        </CardContent>

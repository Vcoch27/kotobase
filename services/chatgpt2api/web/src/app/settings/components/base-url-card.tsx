        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-stone-500">Đặt giá trị cấu hình `CHATGPT2API_BASE_URL`. Lưu là có hiệu lực ngay.</p>
            </div>
          </div>
        ...
        {isLoadingConfig ? (
          ...
          <>
            <div className="space-y-2">
              ...
              />
              <p className="text-sm text-stone-500">Để trống sẽ dùng biến môi trường hoặc giá trị mặc định. Tự động xóa khoảng trắng đầu cuối khi lưu.</p>
            </div>

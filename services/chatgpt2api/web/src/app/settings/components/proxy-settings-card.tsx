        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-stone-500">Cấu hình proxy chung cho các yêu cầu đi ra; lưu là có hiệu lực ngay.</p>
            </div>
          </div>
          ...
          <>
            <div className="space-y-2">
              ...
              <p className="text-sm text-stone-500">
                Để trống thì không dùng proxy. Điền đầy đủ địa chỉ, ví dụ `http://127.0.0.1:7890`, `http://user:pass@127.0.0.1:7890` hoặc `socks5://127.0.0.1:7890`.
              </p>
            </div>

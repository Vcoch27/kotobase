      ...
      <Dialog open={isCanvasDialogOpen} onOpenChange={setIsCanvasDialogOpen}>
        <DialogContent showCloseButton={false} className="rounded-2xl p-6">
          <DialogHeader className="gap-2">
            <DialogTitle>Chuyển đến ứng dụng bên thứ ba</DialogTitle>
            <DialogDescription className="text-sm leading-6">
              Lối vào này chỉ để kiểm tra cá nhân, khuyến nghị tự triển khai trên máy chủ trước khi sử dụng lâu dài. URL chuyển tiếp sẽ mang theo địa chỉ dự án và khóa hiện tại để tự động điền thông tin kết nối. Nếu không yên tâm, bạn có thể hủy và tự nhập thủ công.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-2">
            <div className="text-xs font-medium text-stone-500">URL chuyển tiếp đầy đủ</div>

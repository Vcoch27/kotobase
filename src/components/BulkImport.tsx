...
(AI sẽ tự động tìm từ vựng, Hiragana, Hán Việt, Nghĩa và đặt câu ví dụ Nhật - Việt chuẩn xác)"
                  ...
                  <div className="flex justify-end pt-1 pb-4 sm:pb-0">
                    <button
                      type="button"
                ...
                <div className="space-y-4 animate-fadeIn">
                  ...
                  <div className="flex justify-end pt-1 pb-4 sm:pb-0">
                    <button
                      ...
                      className="flex items-center gap-1.5 px-6 py-2.5 text-xs font-bold text-white bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 rounded-xl transition-all shadow-md shadow-indigo-600/20 active:scale-95"
                    >
            ...
            <div className="flex flex-col gap-4 animate-fadeIn">
              ...
              {/* Nút hành động */}
              <div className="flex items-center justify-between gap-3 pt-2 pb-4 sm:pb-0">
                <button
                  type="button"
                  onClick={() => {
                    setStep("input");

        ...
        {loading ? (
          ...
          <form onSubmit={handleSave} className="p-6 space-y-4 max-h-[70vh] overflow-y-auto custom-scrollbar">
            ...
            <div>
              ...
              {/* Hiển thị Highlight trực quan */}
              {mnemonic.trim() && (
                <div className="mt-2 p-3 rounded-xl bg-slate-100/80 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/80 transition-all">

        ...
        <div className="relative max-w-2xl mx-auto">
          <div className="flex items-stretch gap-2">
            <div className="relative flex-1">
              ...
              {feedback === "correct" && (
                <div className="absolute right-4 sm:right-6 top-1/2 -translate-y-1/2 text-emerald-500 animate-bounce pointer-events-none">
            ...
            <div className="flex sm:hidden items-stretch gap-1.5 shrink-0">
              ...
              {feedback === "correct" ? (
                ...
                <button
                  ...
                  onClick={handleCheck}
                  className="px-3.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 disabled:bg-slate-200 disabled:dark:bg-slate-800 disabled:text-slate-400 text-white font-bold text-xs flex items-center gap-1 active:scale-95 transition-all shadow-md shadow-indigo-500/20 select-none"
                  title="Kiểm tra"
                >
                  <span>Gửi</span>
                </button>
